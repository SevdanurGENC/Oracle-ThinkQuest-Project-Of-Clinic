...
<table width="881" border="0" align="center" cellpadding="0" cellspacing="0" class="white">
	...
	<tr>
      ...
      <form method="post" action="index.jsp">
                    ...
                    <tr>
                            <td class="heading_2">Welcome !!! </td>
                    </tr>
                             
                    <tr>
                            <td class="left_link"><a href="#" class="leftlink"><input type="submit" name="btnlogoff" value="LogOff" /></a></td>
                    </tr>
          </form>                               
        ...
        {  
            ...
            PreparedStatement ps=connect.prepareStatement("select tbl_appointments.row_id, tbl_appointments.patient_name, tbl_appointments.patient_surname, "
                    + "tbl_appointments.appointment_time, tbl_appointments.appointment_date from tbl_doctors, tbl_appointments "
                    + "where tbl_doctors.dr_name = tbl_appointments.doctor_name and tbl_doctors.dr_surname = tbl_appointments.doctor_surname and "
                    + "dr_name=? and  dr_surname=?");
 ...
 <TABLE BORDER="1" BGCOLOR="FFFFFF" width='75%' cellspacing='1' cellpadding='0' bordercolor="black" border='1'>
    ...
    <% while(rs.next ()){ %>
        <TR>
            ...
            <TD> <font size='2'><center><%= rs.getString ("row_id") %></center></TD>
