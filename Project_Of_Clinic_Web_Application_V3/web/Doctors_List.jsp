...
<table width="881" border="0" align="center" cellpadding="0" cellspacing="0" class="white">
	...
	<tr>
      ...
      <form method="post" action="Doctors_List.jsp">
				...
				<td align="center" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="heafing">Welcome List Of Doctors</td>
					</tr>
					<tr>
    ...
    <% while(rs.next ()){ %>
            ...
            <TD> <font size='2'><%= rs.getString ("DR_NAME") %></center></TD>
            <TD> <font size='2'><%= rs.getString ("DR_SURNAME") %></center></TD>
            <TD> <font size='2'><%= rs.getString ("CERTIFICATE_NO") %></center></TD>
